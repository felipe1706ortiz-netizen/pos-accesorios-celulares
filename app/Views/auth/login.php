<div class="auth-card">
  ...
  <div style="margin-top: 1.75rem; padding-top: 1.25rem; border-top: 1.5px solid var(--border-color); font-size: 0.82rem; color: var(--text-muted); text-align: center; background: #f8fafc; border-radius: var(--radius-md); padding: 0.85rem;">
